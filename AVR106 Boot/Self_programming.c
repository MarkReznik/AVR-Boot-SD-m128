...
void (*__AddrToZ24WordToR1R0ByteToSPMCR_SPM_F_Test)(void flash *addr, unsigned int data)= (void(*)(void flash *, unsigned int)) 0x0F9F6;
...
unsigned char WriteFlashPage(MyAddressType flashStartAdr, unsigned char *dataPage)
{
  ...
  if( AddressCheck(flashStartAdr) ){
    ...
    __AddrToZ24ByteToSPMCR_SPM_W((void flash *)0x1EF00);
    __AddrToZ24ByteToSPMCR_SPM_E((void flash *)0x1EF00);
